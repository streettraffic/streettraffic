  ...
  <v-layout row wrap>
    <v-flex xs6 class="my-3">
      ...
      <div>
        ...
        <v-btn dark left default @click.native="loadControls" class="ml-0 mt-3">2. Finished Drawing Polygon</v-btn>
      </div>
    </v-flex>
    <v-flex xs12>
...
+</v-card-text>
    ...
    <v-btn dark default @click.native="displayGeoJson">Load Drawing Tools</v-btn>
  </v-layout>
</template>
