...
class DataFeed:
    ...
    async def init(self):
        ...
        print('========set data type========')
        self.task_list += [self.loop.create_task(self.monitor_flow_data_feed('flow_data'))]
        self.task_list += [self.loop.create_task(self.monitor_flow_data_feed('road_data'))]
        self.task_list += [self.loop.create_task(self.monitor_flow_data_feed('original_data'))]
        self.task_list += [self.loop.create_task(self.monitor_flow_data_feed('crawled_batch'))]
